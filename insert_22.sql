...
VALUES (seq_customer_payments.NEXTVAL, 000000001, 000000001, '600', 'Y', '13/JAN/2017');

INSERT INTO customer_payments
VALUES (seq_customer_payments.NEXTVAL, 000000002, 000000002, '1850', 'Y', '10/DEC/2016');

INSERT INTO customer_payments
VALUES (seq_customer_payments.NEXTVAL, 000000003, 000000003, '750', 'N', '27/JUN/2016');

INSERT INTO customer_payments
VALUES (seq_customer_payments.NEXTVAL, 000000004, 000000004, '825', 'Y', '05/SEP/2016');

INSERT INTO customer_payments
VALUES (seq_customer_payments.NEXTVAL, 000000005, 000000005, '600', 'N', '23/MAR/2017');
...
INSERT INTO sales_reps
VALUES(seq_sales_reps.NEXTVAL, 'MR', 'JAMES','GOODWICK', 07567888008, 'JAMESGOODWICK@GMAIL.COM' , 'SALES', 'M','13/MAR /2017', 0000000002);

INSERT INTO sales_reps
VALUES(seq_sales_reps.NEXTVAL, 'MRS', 'JANE','POTTS', 07263888708, 'JANEPOTTS@GMAIL.COM' , 'SALES', 'F','1/FEB/2017', 0000000003);

INSERT INTO sales_reps
VALUES(seq_sales_reps.NEXTVAL, 'MRS', 'JASMINE','BROWN', 0722348708, 'JASMINEBROWN@GMAIL.COM' , 'SALES','F', '5/JAN/2017', 0000000004);

INSERT INTO sales_reps
VALUES(seq_sales_reps.NEXTVAL, 'MR', 'TOM','JONES', 07255487063, 'TOMJONES@GMAIL.COM' , 'SALES','M', '7/JAN/2017', 0000000005);

-- Holidays
INSERT INTO holidays
VALUES (seq_holidays.NEXTVAL, 0000000001, 0000000001, 0000000001);

INSERT INTO holidays
VALUES (seq_holidays.NEXTVAL, 0000000002, 0000000002, 0000000002);

INSERT INTO holidays
VALUES (seq_holidays.NEXTVAL, 0000000003, 0000000003, 0000000003);

INSERT INTO holidays
VALUES (seq_holidays.NEXTVAL, 0000000004, 0000000004, 0000000004);

INSERT INTO holidays
VALUES (seq_holidays.NEXTVAL, 0000000005, 0000000005, 0000000005);

-- Holiday Details
INSERT INTO holiday_details
VALUES (seq_holiday_details.NEXTVAL,'600', '14/MAY/2017', '23/MAY/2017', 'SPAIN', 'ENQUIRY@EASYJET.COM', 0000000001, 0000000001, 0000000001, 0000000001);

INSERT INTO holiday_details
VALUES (seq_holiday_details.NEXTVAL, '1850', '02/JUN/2017', '20/JUN/2017', 'CHINA', 'CSAIRLINES.ENQUIRY@CSA.COM', 0000000002, 0000000002, 0000000002, 0000000002);

INSERT INTO holiday_details
VALUES (seq_holiday_details.NEXTVAL, '750', '27/JUN/2017', '07/JUL/2017','MALTA', 'ENQUIRY@BRTISHAIRWAYS.COM', 0000000003, 0000000003, 0000000003, 0000000003);

INSERT INTO holiday_details
VALUES (seq_holiday_details.NEXTVAL, '825', '14/APR/2017', '03/MAY/2017','FRANCE', 'ENQUIRY@FLYBE.COM', 0000000004, 0000000004, 0000000004, 0000000004);

INSERT INTO holiday_details
VALUES (seq_holiday_details.NEXTVAL, '600', '14/SEP/2017', '23/SEP/2017', 'NETHERLANDS', 'ENQUIRY@EASYJET.COM', 0000000005, 0000000005, 0000000005, 0000000005);
