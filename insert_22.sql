...
INSERT INTO bills
VALUES(seq_bill_id.NEXTVAL, 'AMBER', 'RAWLINS', 9999, '19/MAR/2017', 'AVENUE CAMPUS NORTHAMPTON NN2 6JD', 1234567891);

INSERT INTO bills
VALUES(seq_bill_id.NEXTVAL, 'ALFIE', 'ENGLAND', 1584, '28/MAR/2015', 'CARAVAN ROAD LONG ITCHINGTON CV47 SA3', 1234567891);

INSERT INTO bills
VALUES(seq_bill_id.NEXTVAL, 'BROOK', 'SMITH', 8387, '02/APR/2016', 'GRANGE FARM DRIVE STOCKTON CV37 8FT', 1234567891);

INSERT INTO bills
VALUES(seq_bill_id.NEXTVAL, 'THOMAS', 'WEAVER', 7722, '12/JAN/2017', 'WEEBLE ROAD LINCOLN SA12 ME4', 1234567891);

INSERT INTO bills
VALUES(seq_bill_id.NEXTVAL, 'ALAN', 'MEADE', 4375, '24/JUL/2016', 'STEAVE ROAD NORTHAMPTON NN2 3FM', 1234567891);
